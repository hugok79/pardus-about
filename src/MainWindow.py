...
from util import PardusInfoManager, ComputerManager
...
pardusInfoManager = PardusInfoManager.PardusInfoManager()
...
class MainWindow:
    ...
    def read_pardus_info(self):
        pardus_info = pardusInfoManager.get_info()
        self.ui_hostname_label.set_text(pardus_info["hostname"])
        self.ui_pardus_label.set_text(pardus_info["pardus"])
