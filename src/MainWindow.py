...
class MainWindow:
    ...
    def __init__(self, application):
        ...
        self.ui_main_window.set_title(_("About Pardus"))
    ...
    def define_components(self):
        ...
        self.ui_pardus_label = UI("ui_pardus_label")
    ...
    def read_pardus_info(self):
        pardus_info = osManager.get_info()
        self.ui_hostname_label.set_text(pardus_info["hostname"])
        self.ui_pardus_label.set_text(pardus_info["os_pretty_name"])
        self.ui_kernel_label.set_text(pardus_info["kernel"])
        return
    ...
    def read_hardware_info(self, task, source_object, task_data, cancellable):
        ...
        #OS
        pardus_info = osManager.get_info()
        self.ui_detail_os_name_label.set_text(pardus_info["os_name"])
        self.ui_detail_os_codename_label.set_text(pardus_info["os_codename"])
        self.ui_detail_os_version_label.set_text(pardus_info["os_version"])
        self.ui_detail_os_kernel_label.set_text(pardus_info["kernel"])
        #self.ui_detail_os_desktop_label.set_text(pardus_info["wayland"])
